...
HD_PWD='F:/vivado/jizu/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count74.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count74.tcl
