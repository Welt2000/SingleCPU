...
HD_PWD='F:/vivado/jizu/CPU/CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singlecycleCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singlecycleCPU.tcl
